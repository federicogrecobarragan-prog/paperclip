...
export const heartbeatRuns = pgTable(
  "heartbeat_runs",
  {
    ...
    terminalFinalizationJson: jsonb("terminal_finalization_json").$type<Record<string, unknown>>(),
    terminalFinalizationAttemptedAt: timestamp("terminal_finalization_attempted_at", { withTimezone: true }),
    terminalFinalizedAt: timestamp("terminal_finalized_at", { withTimezone: true }),
